...
- `browser.challenge`: stop and use the
  [browser verification runbook](browser-operations.md). Expected recovery is
  passed headless smoke, ready preflight, then `crawl.succeeded`.
