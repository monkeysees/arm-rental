...
launch is **not yet approved**: hosted CI/artifact scanning, live staging
exercises, and production control evidence listed below remain mandatory.
...
GitHub, live upstream services, a provisioned staging host, or the production
platform.
